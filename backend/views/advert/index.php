...
<div class="nav-tabs-custom">
    ...
    <div class="tab-content">
        ...
        <div class="box box-success">
            ...
            <div class="box-body">
                <?= Html::beginForm(['advert/index'], 'get', ['class' => 'form-horizontal']) ?>

                <div class="form-group">
                    <label class="col-xs-12 col-sm-3 col-md-2 col-lg-1 control-label">广告标题</label>
                ...
                <div class="form-group">
                    ...
                    <div class="col-xs-12 col-sm-8 col-md-8 col-lg-4">
                        ...
                        <a href="<?= Url::toRoute(['advert/index']) ?>">
            ...
            <?= MyGridView::widget([
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'format' => 'raw',
                        'value' => function ($model) {
                            return Html::a(Utils::cutStr($model->url, 30), $model->url, ['title' => $model->url]);
                        },
                    ],
                    [
                        'attribute' => 'deadline',
                    ...
                    [
                        ...
                        'headerOptions' => ['width' => '100'],
                        'value' => function ($model) {
                            return Advert::STATUS_LABEL[$model->status];
                        },
                    ],
                    [
