 ...
 * @var $query \common\models\RobotAlimamaGao
 */
$this->title = '淘宝联盟采集';
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            return \common\models\RobotAlimamaGao::FROM_CATEGORY[$model->from_cid];
                        }
                    ],
                    [
                        'attribute' => 'to_cid',
...
<script>
    function runRobots() {
        var run = function (pageNum, num) {
            $.post('<?= Url::to(['robot-alimama-gao/run'])?>', {pageNum: pageNum, num: num}, function (response) {
                if (response.code === 0) {
