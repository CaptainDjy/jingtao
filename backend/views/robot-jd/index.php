 ...
 * @var $query \common\models\RobotJd
 */
$this->title = '京东采集';
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            return \common\models\RobotJd::FROM_CATEGORY[$model->from_cid];
                        }
                    ],
                    [
                        'attribute' => 'to_cid',
...
<script>
    function runRobots() {
        var run = function (pageNum, num) {
            $.post('<?= Url::to(['robot-jd/run'])?>', {pageNum: pageNum, num: num}, function (response) {
                if (response.code === 0) {
