 ...
 * @var $query \common\models\RobotDataoke
 */
$this->title = '大淘客采集';
                ...
                'columns' => [
                    ...
                    [
                        ...
                        'value' => function ($model) {
                            return \common\models\RobotDataoke::FROM_CATEGORY[$model->from_cid];
                        }
                    ],
                    [
                        'attribute' => 'to_cid',
...
<script>
    function runRobots() {
        var run = function (pageNum, num) {
            $.post('<?= Url::to(['robot-dataoke/run'])?>', {pageNum: pageNum, num: num}, function (response) {
                if (response.code === 0) {
