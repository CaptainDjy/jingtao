...
class ResetPasswordForm extends Model
{
    ...
    public function scenarios()
    {
        ...
        $scenarios['password'] = ['mobile', 'password', 'rePassword', 'smsCode'];
        return $scenarios;
    }
    ...
    {
        return [
            [['mobile', 'password', 'rePassword'], 'required', 'on' => 'password'],
            [['mobile', 'payPwd', 'rePayPwd', 'smsCode'], 'required', 'on' => 'pay_pwd'],
            [['password'], 'string', 'min' => 6, 'tooShort' => '密码太过简单，长度不能小于6位数', 'message' => '密码太过简单,请输入6-16数字加字母格式密码'],
