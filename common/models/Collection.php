 ...
 * @property string $origin_id 商品/店铺ID
...
//        $model->good_type = $data['good_type'];
    ...
    {
        return $this->hasOne(Goods::class, ['origin_id' => 'origin_id'])->select('origin_id,title,thumb,origin_price,coupon_price,coupon_money,');
    }
}
